...
/* ── Y la escala ─────────────────────────────────────────────────────────
 *
 * Las unidades no tienen medida física, pero la PROPORCIÓN con el tamaño de una
 * butaca sí importa, y la primera versión la tenía mal: con anillos de 130 de
 * fondo y butacas de 24, en cada tribuna cabían siete. Un arena con tribunas de
 * siete asientos no es un arena; se vio al llenar una y mirarla.
 *
 * Con estas medidas, una tribuna de 20° admite del orden de 16 filas de 16, que
 * es lo que tiene una de verdad. La butaca (`geometriaDelPlano.LADO`) es la
 * regla de todo el plano, así que las medidas se dan en múltiplos suyos. */
const MEDIDAS = {
  tarima: { ancho: 1300, alto: 300 },
  pista:  { rInterior: 500, rExterior: 1250 },
  anillo: { grueso: 520, hueco: 90 },
};
