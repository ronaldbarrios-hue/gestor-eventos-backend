...
function frontendUrl() {
  return (process.env.FRONTEND_URL || 'https://gestor-eventos-frontend.vercel.app')
...
/* Se llama DESPUÉS de emitir la boleta: cierra la fila de esa persona y quema
   el token para que el enlace del correo no valga dos veces. */
async function consumirOferta(waitlistId) {
  ...
  try {
    ...
    /* La boleta ya está emitida. Que no se cierre la fila es un desajuste
       menor y arreglable a mano; tumbar la compra por esto, no. */
