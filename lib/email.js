...
function plantillaTicket({ eventoTitulo, eventoCoverUrl, eventoFecha, eventoLugar, nombre, codigo, tipoNombre, linkTicket, gratis }) {
  ...
  const body = `
    ...
    <p style="margin:0 0 22px;font-size:15px;line-height:1.6;color:#94A3B8;">
      ${gratis ? 'Reservaste' : 'Compraste'} <strong style="color:#E2E8F0;">${escapeHtml(tipoNombre || 'una entrada')}</strong> para este evento. Guarda este correo o el link de abajo — lo vas a necesitar en la entrada.
    </p>
