...
const CAMPOS_EDITABLES_ORGANIZADOR = ['nombre', 'descripcion', 'logo_url', 'stand',
  ...
  /* Quién recibe y quién pasa (0105). Lo decide quien organiza: es cómo está
     armada SU rueda, no una preferencia de la empresa. */
  'rol',
  /* Y si su contacto se enseña en la rueda pública. Está en las dos listas
     —aquí y en la de la empresa— a propósito: el organizador lo necesita para
     poder APAGARLO cuando alguien se arrepiente, y la empresa para encenderlo
     sobre sus propios datos. Quien no pueda apagarlo tampoco debería poder
     encenderlo, y al revés deja a la gente sin forma de retirarse. */
  'contacto_publico'];
...
const CAMPOS_EDITABLES_EXPOSITOR = ['nombre', 'descripcion', 'logo_url', 'stand',
  ...
  /* Publicar su propio contacto: sí. Son SUS datos, y quien los da es quien
     decide si salen. `rol` NO está: dónde se sienta cada uno en la rueda es
     del que la arma, igual que `zona_id`. */
  'contacto_publico'];
